...
\begin{align*}
\rho(\bx) \equiv \int d^3v\, f\big(\bJ(\bx,\bv)\big), \quad
\overline{\bv} \equiv \rho^{-1} \int d^3v \,\bv\, f\big(\bJ(\bx,\bv)\big), \quad
\overline{v_{ij}} \equiv \rho^{-1} \int d^3v \,v_{ij}\, f\big(\bJ(\bx,\bv)\big).
\end{align*}
