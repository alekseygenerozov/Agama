...
private:
    const potential::OblatePerfectEllipsoid& pot;  ///< the potential in which actions are computed
};
...
private:
    const potential::BasePotential& pot;    ///< the potential in which actions are computed
