...
public:
    ...
    virtual void evalDeriv(const double E, double* h=0, double* g=0, double* =0) const;
    ...
    double E(const double h, double* g=0) const;
...
private:
    double Phi0;                ///< value of potential at r=0
...
public:
    ...
    any non-default value should be > -1.
